...
<html lang="en">
  ...
  <body class="container">
    ...
    <form class="form-group" action="db.php" method="post">
        ...
        <label>Enter SCP Item Number here:</label>
        <br>
        <input type="text" name="pg" placeholder="Enter SCP Item Number here" class="form-control" value="<?php echo $row['pg']; ?>">
        <br>
        <label>Enter SCP Object Class:</label>
        <br>
        <input type="text" name="h1" placeholder="Enter SCP Object Class" class="form-control" value="<?php echo $row['h1']; ?>">
        <br>
        <label>What Are The Special Containment Features?:</label>
        <br>
        <input type="text" name="h2" placeholder="What Are The Special Containment Features?" class="form-control" value="<?php echo $row['h2']; ?>">
        <br>
